...
int main(){
    int ele, n, m;
    vector<int> books;
    cout<<"Enter the no. of time elements: ";
    cin>>n;
    cout<<"Enter time taken to paint for each parts: ";
    for(int i = 0;i<n;i++){
        cin>>ele;
        books.push_back(ele);
    }
    ...
    cin>>m;
    cout<<"Minimum of all maximums of subarrays is "<<findLargestMinDistance(books, m)<<endl;
}